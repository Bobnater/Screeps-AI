    ...
    run: function(creep) {
        ...
        if (creep.memory.working == true) {
            ...
            var energystore = creep.pos.findClosestByPath(FIND_STRUCTURES, {
                filter: (i) => ((i.structureType == STRUCTURE_CONTAINER || i.structureType == STRUCTURE_STORAGE) && i.store[RESOURCE_ENERGY] > 200) || (i.structureType == STRUCTURE_LINK && i.energy > 200)
               });
            if (energystore !== null) {
